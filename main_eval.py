...
def main():
    ...
    # Define metric evaluation parameters below
    ...
    evaluation_parameters = {
        ...
        "MC samples": 10 ** 4 # Only relevant for grid-free evaluation
    }
    ...
    reference_name = "kf"
    #reference = ParticleFilter(sde, timepoints_reference, m_indices_reference, n_particles=10000)
    #reference_name = "pf 10000"

    # Benchmark filters
    pf = ParticleFilter(sde, timepoints_benchmarks, m_indices_benchmarks, n_particles = 100)
    #ekf = ExtendedKalmanFilter(sde, timepoints_benchmarks, m_indices_benchmarks)
    #pf2 = ParticleFilter(sde, timepoints_benchmarks, m_indices_benchmarks, n_particles = 10)
